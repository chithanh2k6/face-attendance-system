...
- Tránh ghi trùng điểm danh trong cùng một ngày cho cùng một nội dung điểm danh.
...
- Thống kê theo môn / lớp học phần.
...
1. Mở tab `Điểm danh`.
2. Nhập nội dung điểm danh nếu cần, ví dụ:
   - Trí tuệ nhân tạo
   - Lập trình Python
   - CNTT01
   - Nhóm thực hành 1
...
- Thêm quản lý môn học và lớp học phần riêng.
- Thêm quản lý buổi học.
